...
\begin{itemize}
    ...
    \item \textbf{Stacking}: We train a Stacking Classifier utilizing five base models (LightGBM, XGBoost, Random Forest, Logistic Regression, MLP) and feed their out-of-fold probability predictions into a Logistic Regression meta-classifier.
